...
if __name__ == '__main__':
    data_type = "train"
    img_path = "./data/"+data_type+"/top"
    img_new_path = "./data/"+data_type+"/top_new"
    label_path ="./data/"+data_type+"/label_single"
    label_new_path = "./data/"+data_type+"/label_single_new"
    folder = os.path.exists( img_new_path)
